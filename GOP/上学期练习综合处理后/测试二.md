## 1. 德文题目
z### Kapitel Wahrscheinlichkeitsbegriff  

**Welche der folgenden Aussagen sind wahr?**  

**Select one or more:**  

- [x] **1.** Die Wahrscheinlichkeit eines Ereignisses ist eine subjektive Größe – sie drückt aus, wie sicher oder unsicher die Beobachtenden sich über das Nicht-Eintreten oder Eintreten des Ereignisses sind.  

- [x] **2.** Die Wahrscheinlichkeit eines Ereignisses ist objektiv quantifizierbar – sie drückt aus, mit welcher relativen Häufigkeit das Ereignis eintritt, wenn der zufällige Prozess, der das Ereignis erzeugt, oft wiederholt wird.  

- [ ] **3.** $P(A)=0 \Longleftrightarrow$ „Das Ereignis $A$ tritt nie ein.“  

- [ ] **4.** „Das Ereignis $A$ tritt immer ein.“ $\Longleftrightarrow P(A)=\infty$.  

- [x] **5.** „Wahrscheinlichkeit“ ist ein mathematisch wohldefinierter Begriff, der aber unterschiedliche Interpretationsmöglichkeiten beinhaltet.  
...
- [x] **1.** Von Laplace-Wahrscheinlichkeiten spricht man dann, wenn die Wahrscheinlichkeit aller Ereignisse proportional zur Anzahl der Elementareignisse, die das Ereignis beinhaltet, ist.  
...
- [x] **4.** Wir werfen zweimal eine Münze. Das Ereignis „Zuerst Zahl, dann Kopf“ ist genauso wahrscheinlich wie das Ereignis „Zweimal Kopf“.  

- [x] **5.** Elementareignisse haben immer alle die gleiche Wahrscheinlichkeit.  
...
- [x] **1.** Eine Grundgesamtheit $\Omega$ ist eine Menge von Elementarereignissen $\omega$.  

- [ ] **2.** Mehrere Elementarereignisse $\omega$ können gleichzeitig bzw. gemeinsam eintreten.  

- [x] **3.** Ein Ereignis $A$ ist formal einfach nur eine Teilmenge der Grundgesamtheit:  
  $$
  A \subseteq \Omega
  $$  
  $$
...
- [x] **4.** Falls Ereignis $B$ immer nur zusammen mit Ereignis $A$ auftreten kann, ist die Wahrscheinlichkeit, dass $A$ oder $B$ auftritt, das Maximum ihrer beiden Wahrscheinlichkeiten.  
