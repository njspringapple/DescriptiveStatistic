...
![[DescriptiveStatistic/GOP/图片/2df7acd6-60cc-443c-89ec-915ee2191a54.png]]
...
- [x] **1.** Untersuchungseinheiten sind hier die Bundesstaaten der USA, jeweils in einem bestimmten Jahr.
...
- [x] **4.** Visualisierte Merkmale, denen hier ästhetische Eigenschaften zugeordnet werden, sind der Name des Bundesstaates, das Jahr und die Infektionsraten.
...
- [x] **7.** Hier werden Rechtecke als Geometrie verwendet.
...
- [x] **11.** Ästhetik: horizontale Position ↔ Jahr, vertikale Position ↔ Bundesstaat, Farbe ↔ Infektionsrate
...
- [x] **14.** Die gewählten Geometrien, ästhetischen Mappings und ihre Skalen sind sehr gut geeignet, um Unterschiede in den Verläufen der Infektionsraten zwischen den Bundesstaaten abzulesen.
