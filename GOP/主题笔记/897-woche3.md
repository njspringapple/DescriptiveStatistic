...
5. 至少需要多少名玩家，才能以至少 $95\%$ 的概率保证在第一轮掷骰中有人掷出 6？给出思路和计算过程。
...
6. $M$ 是否也服从几何分布？请根据 $F_M$ 的形式说明理由，并用 $p = 1/6, n = 4$ 的具体数值来反驳这个猜测。
...
11. 对于独立的 $X_1, \ldots, X_n$，有 $F_{\max}(z) = \prod_{i=1}^n F_{X_i}(z)$。
