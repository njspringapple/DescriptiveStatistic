...
const file="Familie.html";
const expected='<script src="word-scenes-custom.js"></script><script src="word-scene.js"></script>';
const replacement='<script src="word-scenes-custom.js"></script><script src="word-scenes-familie-a.js"></script><script src="word-scenes-familie-b.js"></script><script src="word-scene.js"></script>';
